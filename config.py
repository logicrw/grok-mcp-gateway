...
GROK_PROXY_RETRIEVE_TOTAL_TIMEOUT_SECONDS: float = _env_float(
    "GROK_PROXY_RETRIEVE_TOTAL_TIMEOUT_SECONDS", 180.0, minimum=10.0, maximum=600.0
)
...
GROK_PROXY_SMART_STAGE_TIMEOUT_SECONDS: float = _env_float(
    "GROK_PROXY_SMART_STAGE_TIMEOUT_SECONDS", 120.0, minimum=5.0, maximum=180.0
)
...
GROK_PROXY_RAW_STAGE_TIMEOUT_SECONDS: float = _env_float(
    "GROK_PROXY_RAW_STAGE_TIMEOUT_SECONDS", 50.0, minimum=2.0, maximum=120.0
)
